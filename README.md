...
Supported UnrealEngine version: 4.22-5.8
...
*5.7.0
  ...
  Update [HorizonUI](https://github.com/dorgonman/HorizonUIPluginDemo) to 5.7.0  

  Update [HorizonTween](https://github.com/dorgonman/HorizonTweenDemo) to 5.7.0  

  Update [HorizonFramework](https://github.com/dorgonman/HorizonFrameworkDemo) to 5.7.0 

*5.6.0

  Update to 5.6.0

  Update [HorizonUI](https://github.com/dorgonman/HorizonUIPluginDemo) to 5.6.0  

  Update [HorizonTween](https://github.com/dorgonman/HorizonTweenDemo) to 5.6.0  

  Update [HorizonFramework](https://github.com/dorgonman/HorizonFrameworkDemo) to 5.6.0 

*5.5.0

  Update to 5.5.0

  Update [HorizonUI](https://github.com/dorgonman/HorizonUIPluginDemo) to 5.5.0  

  Update [HorizonTween](https://github.com/dorgonman/HorizonTweenDemo) to 5.5.0  

  Update [HorizonFramework](https://github.com/dorgonman/HorizonFrameworkDemo) to 5.5.0 
...
*5.3.0
  ...
  Update [HorizonUI](https://github.com/dorgonman/HorizonUIPluginDemo) to 5.3.0  
