# Jenkins Automation for HorizonDialogueDemo

This directory contains the Jenkins Pipeline configuration for the HorizonDialogueDemo project. It uses a shared pipeline library to provide standardized Unreal Engine build and test workflows.
...
- `HorizonPlugin/HorizonDialogueDemo/Build/Development` — `*StandaloneTestReport.tar` and `Intermediate/BuildArchive/doc/` public docs.
- `HorizonPlugin/HorizonDialogueDemo/Build/UGSBuild` — `Intermediate/BuildUGS/NuGet/*.nupkg`.
