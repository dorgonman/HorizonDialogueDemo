...
pipeline {
    parameters {
        ...
        string(name: 'UGS_BUILD_JOB_NAME', defaultValue: 'HorizonDialogueDemo-UGSBuild', description: 'Name of the UGS build job to copy artifacts from')
    ...
    agent {
        node {
            ...
            customWorkspace "${sharedWorkspaceRoot}/HorizonPlugin/HorizonDialogueDemo/Deploy"
        }
    }
