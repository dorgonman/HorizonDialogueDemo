// HorizonDialogueDemo — Jenkins Shared Library consumer configuration
...
def projectConfig() {
    return [
        ...
        deployWorkspace:        '',  // Auto-resolved if empty: "${sharedWorkspaceRoot}/HorizonPlugin/HorizonDialogueDemo/Deploy"
        ...
        sentryProject: 'horizondialoguedemo',
        ...
        hordeGitStreamRepo: 'https://dev.azure.com/kanohorizonia/UEHorizonPlugin/_git/HorizonDialogueDemo',  // Repo URL for Horde stream ID (without trailing .git)

        // === Plugin Validation ===
        // Plugin validation is opt-in in the shared library. This PluginDemo project enables it explicitly.
        bValidatePlugins:   true,
        pluginName:         'HorizonDialoguePlugin',
        pluginValidationPaths: [
            'Plugins/HorizonDialoguePlugin/HorizonDialoguePlugin.uplugin',
        ],
        pluginValidationIncludeRegex: '^Plugins/.*\\.uplugin$',
        pluginValidationExcludeRegex: '^Plugins/Marketplace/',

        // === Consumer metadata ===
        projectName:        'HorizonDialogueDemo',
        uprojectPath:       'HorizonDialogueDemo.uproject',
    ]
}
